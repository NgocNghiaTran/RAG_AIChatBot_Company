...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("Starting BoluTran Chatbot API...")
    try:
    ...
    # Shutdown
    logger.info("Shutting down BoluTran Chatbot API...")

app = FastAPI(
    title="BoluTran Chatbot API",
    description="API for BoluTran Chatbot",
    version="1.0.0",
    lifespan=lifespan
)
