...
Chatbot thông minh sử dụng Retrieval-Augmented Generation (RAG) để trả lời câu hỏi về công ty, dự án kiến trúc, nội thất và tin tức.
...
curl http://localhost:6333/collections/chatbot_collection
